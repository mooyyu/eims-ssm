...
<div id="filterForm">
    ...
    <form id="filter" class="border border-dark p-4" method="post" action="./employee/doAdd">
        <div class="form-row">
        ...
        <button id="submit" type="submit" class="btn btn-block btn-outline-success">添加</button>
    </form>
